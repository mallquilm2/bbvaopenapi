...
public class EntityTypeObject {
    ...
    private com.bbva.ninja.hero.beans.SetSingularAttributeSuperObjectObject idClassAttributes;
    @JsonProperty("idType")
    ...
    private com.bbva.ninja.hero.beans.SetSingularAttributeSuperObjectObject singularAttributes;
    ...
    @JsonProperty("idClassAttributes")
    public com.bbva.ninja.hero.beans.SetSingularAttributeSuperObjectObject getIdClassAttributes() {
        return idClassAttributes;
    }

    @JsonProperty("idClassAttributes")
    public void setIdClassAttributes(com.bbva.ninja.hero.beans.SetSingularAttributeSuperObjectObject idClassAttributes) {
    ...
    @JsonProperty("singularAttributes")
    public com.bbva.ninja.hero.beans.SetSingularAttributeSuperObjectObject getSingularAttributes() {
        return singularAttributes;
    }

    @JsonProperty("singularAttributes")
    public void setSingularAttributes(com.bbva.ninja.hero.beans.SetSingularAttributeSuperObjectObject singularAttributes) {
